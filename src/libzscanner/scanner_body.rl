...
%%{
	...
	svc_key_generic   = ("key"i             . num16);
	svc_key_mandatory = ("mandatory"i       %_write16_0);
	svc_key_alpn      = ("alpn"i            %_write16_1);
	svc_key_ndalpn    = ("no-default-alpn"i %_write16_2);
	svc_key_port      = ("port"i            %_write16_3);
	svc_key_ipv4hint  = ("ipv4hint"i        %_write16_4);
	svc_key_echconfig = ("echconfig"i       %_write16_5);
	svc_key_ipv6hint  = ("ipv6hint"i        %_write16_6);
